...
export function Footer() {
  return (
    <div className="bg-jet-black body-font">
      <div className="container py-8 flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a href="https://github.com/paaneko" className="text-gray-500">
            <svg
              fill="white"
              strokeLinecap="round"
          ...
          <a href="https://github.com/paaneko" className="ml-3 text-gray-500">
            <svg
              fill="white"
              strokeLinecap="round"
              strokeLinejoin="round"
